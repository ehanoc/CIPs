...
Each store might have their own requirements for the metadata. For example, some stores might require a field for logo, or screenshots links. The store's should advertise what fields they require in their documentation so that developers are aware and they can include them in the metadata.
...
There are no necessary backwards compatibility considerations for this proposal.

## Path to Active

### Acceptance Criteria
- [ ] This interface is utilized by multiple dApp stores/aggregators.
- [ ] This interface is utilized by multiple dApp developers/publishers.
